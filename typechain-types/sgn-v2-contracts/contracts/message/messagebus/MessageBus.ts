...
export interface CallRevertedEventObject {
  reason: string;
}
export type CallRevertedEvent = TypedEvent<[string], CallRevertedEventObject>;
...
export interface MessageWithTransferEventObject {
  sender: string;
  receiver: string;
  dstChainId: BigNumber;
  bridge: string;
