...
// CELER MESSAGE_BUS
const CELER_MESSAGE_BUS_ADDRESS              = "0xaFDb9C40C7144022811F034EE07Ce2E110093fe6"
...
async function deployCoverageDataProviderWrapper() {
  if (await isDeployed(COVERAGE_DATA_PROVIDER_WRAPPER_ADDRESS)) {
    ...
    let tx2 = await coverageDataProviderWrapper.connect(deployer).addReceiver(1, COVERAGE_DATA_PROVIDER_WRAPPER_ADDRESS, networkSettings.overrides);
